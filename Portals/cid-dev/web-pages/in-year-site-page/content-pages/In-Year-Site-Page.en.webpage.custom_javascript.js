...
$(document).ready(function () {
    ...
    if (urlParams.has('id')) {
        ...
        var html1 = "&nbsp;&nbsp;<div id='switchSiteType' role='group' class='btn-group entity-action-button'><a href='~/AuditHistoryLog_Create?id=" + siteId + "'><input type='button' name='SwitchSiteType' value='Switch Site Type' class='btn btn-primary button submit-btn' nonactionlinkbutton='true'></a></div>";
