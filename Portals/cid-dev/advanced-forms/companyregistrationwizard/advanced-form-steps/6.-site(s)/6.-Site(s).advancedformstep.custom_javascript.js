	...
	webFormClientValidate = function () {
		...
		if (data == null) {
			...
			if (data.length <= 0) {
				...
				data = tdg.webapi.SelectedColumnlist("accounts", "name", "statecode eq 0 and cid_issiteattested eq false and (cid_siteclaim eq 100000000 or cid_siteclaim eq 100000001 or cid_siteclaim eq 100000003 or cid_siteclaim eq null) and _parentaccountid_value eq " + companyId);
