...
$(document).ready(function () {
    ...
    if (operationId != '') {
        ...
        var html3 = "&nbsp;&nbsp;<div id='openOperationWizard_Classes' role='group' class='btn-group entity-action-button'><a href='~/OperationRegistrationWizard/?id=" + operationId + "&siteid=" + siteId + "&in_year=true" + (extendedSite ? "&isExtended=true" : "&isExtended=false") + "'><input id='furtherDetailsButton_Classes' type='button' name='FurtherSiteDetails_Classes' value='+ Add' class='btn btn-primary button submit-btn' nonactionlinkbutton='true'" + disabled + "></a></div>";
        ...
        var html5 = "</br><div id='openOperationWizard_MOTs' role='group' class='btn-group entity-action-button '><a href='~/OperationRegistrationWizard/?id=" + operationId + "&siteid=" + siteId + "&in_year=true" + (extendedSite ? "&isExtended=true" : "&isExtended=false") + "'><input id='furtherDetailsButton_MOTs' type='button' name='FurtherSiteDetails_MOTs' value='Update Mode(s) of transportation' class='btn btn-primary button submit-btn' nonactionlinkbutton='true'" + disabled + "></a></div></br></br></br>";
