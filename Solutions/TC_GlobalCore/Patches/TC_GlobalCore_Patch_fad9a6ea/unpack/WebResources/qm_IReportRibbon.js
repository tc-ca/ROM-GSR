...
var IReportRibbon = (function (window, document) {
    ...
    function cancelInspectionReport(selectedItems, gridControl) {
        ...
        Xrm.WebApi.online.retrieveRecord("ovs_tdginspectionreport", selectedItems[0], "?$select=statuscode").then(
            function success(result) {
                ...
                if (statuscode != 2) {
                    ...
                    var alertStrings = { confirmButtonLabel: yesNo, text: "Only Issued reports can be canceled" };
    ...
    function isIssued(selectedItems) {
        ...
        Xrm.WebApi.online.retrieveRecord("ovs_tdginspectionreport", selectedItems[0], "?$select=statuscode").then(
            ...
            function (error) {
                ...
                console.log("isIssued method Error: " + error.message);
            }
        );

        //var req = new XMLHttpRequest();
        //req.open("GET", Xrm.Page.context.getClientUrl() + "/api/data/v9.1/ovs_tdginspectionreports(" + selectedItems[0] + ")?$select=statuscode", false);
        //req.setRequestHeader("OData-MaxVersion", "4.0");
        //req.setRequestHeader("OData-Version", "4.0");
        //req.setRequestHeader("Accept", "application/json");
        //req.setRequestHeader("Content-Type", "application/json; charset=utf-8");
        ...
        //            else return false;
        //        } else {
        //            console.log("isIssued method Error: " + this.statusText);
        //        }
        //    }
        //};
        //req.send();
