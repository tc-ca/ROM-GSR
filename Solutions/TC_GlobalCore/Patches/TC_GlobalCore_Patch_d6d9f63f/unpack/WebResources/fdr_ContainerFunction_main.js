    ...
    return {
        ...
        OnLoad: function (executionContext) {
            ...
            if (formType == 1) {
                ...
                //hide specs if design allowed
                var supportDesign = glHelper.GetValue(formContext, "fdr_supportsdesignregistration");
                glHelper.SetSectionVisibility(formContext, "General", "section_Specifications", !supportDesign);
            }
        },
