...
var SRFunctions_FDR_main = (function (window, document) {
    ...
    function getSpecificationAndLimitations(formContext) {
        ...
        Xrm.WebApi.online.retrieveRecord("fdr_servicerequestfunction", containerId, "?$select=fdr_name&$expand=fdr_fdr_servicerequestfunction_fdr_functionlimitation_servicerequestfunction($select=_fdr_limitation_value,fdr_texten,fdr_textfr),fdr_ServiceRequestFunction_Specification($select=fdr_englishname,fdr_name)").then(
            function success(result) {
                ...
                for (var j = 0; j < result.fdr_fdr_servicerequestfunction_fdr_functionlimitation_servicerequestfunction.length; j++) {
                    var fdr_fdr_servicerequestfunction_fdr_functionlimitation_servicerequestfunction_fdr_limitation = result.fdr_fdr_servicerequestfunction_fdr_functionlimitation_servicerequestfunction[j]["_fdr_limitation_value"];
                    var fdr_fdr_servicerequestfunction_fdr_functionlimitation_servicerequestfunction_fdr_limitation_formatted = result.fdr_fdr_servicerequestfunction_fdr_functionlimitation_servicerequestfunction[j]["_fdr_limitation_value@OData.Community.Display.V1.FormattedValue"];
                    var fdr_fdr_servicerequestfunction_fdr_functionlimitation_servicerequestfunction_fdr_limitation_lookuplogicalname = result.fdr_fdr_servicerequestfunction_fdr_functionlimitation_servicerequestfunction[j]["_fdr_limitation_value@Microsoft.Dynamics.CRM.lookuplogicalname"];
                    var fdr_fdr_servicerequestfunction_fdr_functionlimitation_servicerequestfunction_fdr_texten = result.fdr_fdr_servicerequestfunction_fdr_functionlimitation_servicerequestfunction[j]["fdr_texten"];
                    var fdr_fdr_servicerequestfunction_fdr_functionlimitation_servicerequestfunction_fdr_textfr = result.fdr_fdr_servicerequestfunction_fdr_functionlimitation_servicerequestfunction[j]["fdr_textfr"];

                    if (limitations.length > 0)
                        limitations = limitations + ", ";
                    limitations = limitations + fdr_fdr_servicerequestfunction_fdr_functionlimitation_servicerequestfunction_fdr_texten;

                }

                // Specifications
                for (var j = 0; j < result.fdr_ServiceRequestFunction_Specification.length; j++) {
                    var fdr_ServiceRequestFunction_Specification_fdr_englishname = result.fdr_ServiceRequestFunction_Specification[j]["fdr_englishname"];
                    var fdr_ServiceRequestFunction_Specification_fdr_name = result.fdr_ServiceRequestFunction_Specification[j]["fdr_name"];
                    if (specifications.length > 0)
                        specifications = specifications + ", ";
                    specifications = specifications + fdr_ServiceRequestFunction_Specification_fdr_name;
                }
