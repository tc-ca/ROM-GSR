    ...
    const cepSamplingFunctions = {
        ...
        validateRequiredFields: function (config) {
            ...
            if (!config.recidivismviolationcount) {
                ...
                msg += "> Recidivism When Violation Count is Greater Than or Equals" + " field is required." + "\n";
                success = false;
            }
