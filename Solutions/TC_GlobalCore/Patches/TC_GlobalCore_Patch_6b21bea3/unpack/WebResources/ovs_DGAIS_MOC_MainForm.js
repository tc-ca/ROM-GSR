...
var DGAIS_MOC_MainForm = (function (window, document) {
    ...
    var MOC_List2Forms = {
        ...
        "4": {
            ...
            "required_fields": ["ovs_test_inspection_markings_txt", ""]
        },
        "5": {
        ...
        "8": {
            ...
            "required_fields": ["ovs_manufacturer_registered_mark_txt", ""]
        },
        "9": {
    ...
    function sectionManager(formContext, selectedSectionInfo) {
        ...
        tabObj.sections.forEach(function (sectionObj) {
            ...
            processSectionControls(formContext, tabObj, currentSectionInfo, sectionName, sectionName == selectedSectionInfo.section_name).then(
                function (success) {
    ...
    async function processSectionControls(formContext, tabObj, sectionInfo, sectionName, isVisible) {
        ...
        if (sectionInfo == null) {
            ...
            sectionObj = tabObj.sections.get(sectionInfo.section_name);
