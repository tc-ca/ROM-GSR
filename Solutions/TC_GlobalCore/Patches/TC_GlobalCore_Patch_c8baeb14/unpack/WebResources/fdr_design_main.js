...
var Design_main = (function (window, document) {
    ...
    var globalObj = {};
    globalObj.Mapping = {};
    //globalObj.Mapping.fdr_option = "fdr_option";
    //globalObj.Mapping.fdr_packinggroupmarking = "fdr_packinggroupmarking";
    //globalObj.Mapping.fdr_grossmass = "fdr_grossmass"; //!_
    //globalObj.Mapping.fdr_relativedensity = "fdr_relativedensity";//!_
    //globalObj.Mapping.fdr_packagingmaterial = "fdr_packagingmaterial";
    //globalObj.Mapping.fdr_internaltestpressure = "fdr_internaltestpressure";//!_
    //globalObj.Mapping.fdr_registeredmark = "fdr_registeredmark";//!_
    ////bool => string
    //globalObj.Mapping.fdr_nrcanauthorization = "fdr_nrcanauthorization";//if yes - set required
    //globalObj.Mapping.fdr_maximumpermittedstackingload = "fdr_maximumpermittedstackingload";
    //globalObj.Mapping.fdr_maximumpermissiblegrossmassload = "fdr_maximumpermissiblegrossmassload";
    //globalObj.Mapping.fdr_maximumcapacity = "fdr_maximumcapacity";
    //globalObj.Mapping.fdr_taremass = "fdr_taremass";
    //globalObj.Mapping.fdr_testpressure = "fdr_testpressure";
    //globalObj.Mapping.fdr_maximumloadingdischargepressure = "fdr_maximumloadingdischargepressure";
    //globalObj.Mapping.fdr_bodymaterial = "fdr_bodymaterial";
    //globalObj.Mapping.fdr_minimumthickness = "fdr_minimumthickness";
    //globalObj.Mapping.fdr_maximumallowableworkingpressure = "fdr_maximumallowableworkingpressure";//!_
    //obj
    ...
    // remove, do based on fdr_designreviewagencyreportnumber
    //globalObj.Mapping.fdr_designreviewagencyreportdate = "fdr_designreviewagencyreportdate";
