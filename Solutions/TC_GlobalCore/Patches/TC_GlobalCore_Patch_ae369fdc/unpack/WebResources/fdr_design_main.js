    ...
    function getAllowedDMRfromSpecs(DMR_control, SRF_id, RT_id) {
        ...
        var fetchXml = ["<fetch>"
            + "<entity name='fdr_servicerequestfunction'>"
                ...
                + "<filter type='and'>"
                    + "<condition attribute='fdr_servicerequestfunctionid' operator='eq' value='febd59b9-4da2-ed11-aad1-0022483d0343' />"
                    + "<condition entityname='RT' attribute='fdr_containertypeid' operator='eq' value='8cc1942e-bbc0-ec11-983f-0022483da58f' />"
                + "</filter>"
