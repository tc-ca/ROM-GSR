...
var AccountCRS_org = (function (window, document) {
    ...
    function setFormUsage(formContext) {
        ...
        var accountType = glHelper.GetValue(formContext, "customertypecode");

        if (langId == 1033)
            glHelper.SwitchFormByName(formContext, formMapping_EN[accountType.toString()]);
        else if (langId == 1036)
            glHelper.SwitchFormByName(formContext, formMapping_FR[accountType.toString()]);
