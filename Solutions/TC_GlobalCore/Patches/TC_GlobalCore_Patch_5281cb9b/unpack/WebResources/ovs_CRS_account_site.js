...
var AccountCRS_site = (function (window, document) {
    //variables
    var formType;
    ...
    var PostalAdressArray = new Array("address1_line1", "address1_line2", "address1_city", "address1_stateorprovince", "address1_postalcode", "address1_country");
    ...
    return {
        ...
        OnLoad: function (executionContext) {
            ...
            rTypeCode.removeOnChange(AccountCRS_site.relationShip_OnChange); // avoid binding multiple event handlers
            rTypeCode.addOnChange(AccountCRS_site.relationShip_OnChange);
            //Address type
            var adrType = formContext.getAttribute("ovs_address_type");
            adrType.removeOnChange(AccountCRS_site.AddressType_OnChange);
            adrType.addOnChange(AccountCRS_site.AddressType_OnChange);
            //set org mandatory
