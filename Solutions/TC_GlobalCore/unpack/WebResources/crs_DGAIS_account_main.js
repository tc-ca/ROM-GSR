...
var AccountDGAIS_org = (function (window, document) {
    //variables
    var formType;
    ...
    return {
        ...
        OnLoad: function (executionContext) {
            ...
            rTypeCode.addOnChange(AccountDGAIS_org.relationShip_OnChange);
            //populate bn
            var CRA_BN = formContext.getAttribute("cid_crabusinessnumber");
            CRA_BN.removeOnChange(AccountDGAIS_org.CRABusinessNumber_OnChange);
            CRA_BN.addOnChange(AccountDGAIS_org.CRABusinessNumber_OnChange);

            var reason = formContext.getAttribute("cid_reasonfornobnnumber");
            reason.removeOnChange(AccountDGAIS_org.CRABusinessNumber_OnChange);
            reason.addOnChange(AccountDGAIS_org.CRABusinessNumber_OnChange);

            var reasonText = formContext.getAttribute("cid_reasonfornobnnumber_other");
            reasonText.removeOnChange(AccountDGAIS_org.CRABusinessNumber_OnChange);
            reasonText.addOnChange(AccountDGAIS_org.CRABusinessNumber_OnChange);
