declare namespace web {
  ...
  interface msdyn_workorder_RelatedOne {
    msdyn_SupportContact: WebMappingRetrieve<web.BookableResource_Select,web.BookableResource_Expand,web.BookableResource_Filter,web.BookableResource_Fixed,web.BookableResource_Result,web.BookableResource_FormattedResult>;
    msdyn_billingaccount: WebMappingRetrieve<web.Account_Select,web.Account_Expand,web.Account_Filter,web.Account_Fixed,web.Account_Result,web.Account_FormattedResult>;
    msdyn_parentworkorder_msdyn_workorder: WebMappingRetrieve<web.msdyn_workorder_Select,web.msdyn_workorder_Expand,web.msdyn_workorder_Filter,web.msdyn_workorder_Fixed,web.msdyn_workorder_Result,web.msdyn_workorder_FormattedResult>;
    msdyn_preferredresource: WebMappingRetrieve<web.BookableResource_Select,web.BookableResource_Expand,web.BookableResource_Filter,web.BookableResource_Fixed,web.BookableResource_Result,web.BookableResource_FormattedResult>;
    msdyn_reportedbycontact: WebMappingRetrieve<web.Contact_Select,web.Contact_Expand,web.Contact_Filter,web.Contact_Fixed,web.Contact_Result,web.Contact_FormattedResult>;
    msdyn_serviceaccount: WebMappingRetrieve<web.Account_Select,web.Account_Expand,web.Account_Filter,web.Account_Fixed,web.Account_Result,web.Account_FormattedResult>;
    ovs_FiscalQuarter: WebMappingRetrieve<web.tc_TCFiscalQuarter_Select,web.tc_TCFiscalQuarter_Expand,web.tc_TCFiscalQuarter_Filter,web.tc_TCFiscalQuarter_Fixed,web.tc_TCFiscalQuarter_Result,web.tc_TCFiscalQuarter_FormattedResult>;
    ovs_FiscalYear: WebMappingRetrieve<web.tc_TCFiscalYear_Select,web.tc_TCFiscalYear_Expand,web.tc_TCFiscalYear_Filter,web.tc_TCFiscalYear_Fixed,web.tc_TCFiscalYear_Result,web.tc_TCFiscalYear_FormattedResult>;
    ovs_PrimaryInspector: WebMappingRetrieve<web.BookableResource_Select,web.BookableResource_Expand,web.BookableResource_Filter,web.BookableResource_Fixed,web.BookableResource_Result,web.BookableResource_FormattedResult>;
    ovs_SecondaryInspector: WebMappingRetrieve<web.BookableResource_Select,web.BookableResource_Expand,web.BookableResource_Filter,web.BookableResource_Fixed,web.BookableResource_Result,web.BookableResource_FormattedResult>;
    ovs_TYRational: WebMappingRetrieve<web.ovs_TYRational_Select,web.ovs_TYRational_Expand,web.ovs_TYRational_Filter,web.ovs_TYRational_Fixed,web.ovs_TYRational_Result,web.ovs_TYRational_FormattedResult>;
  }
  interface msdyn_workorder_RelatedMany {
    msdyn_msdyn_workorder_msdyn_workorder_ParentWorkOrder: WebMappingRetrieve<web.msdyn_workorder_Select,web.msdyn_workorder_Expand,web.msdyn_workorder_Filter,web.msdyn_workorder_Fixed,web.msdyn_workorder_Result,web.msdyn_workorder_FormattedResult>;
    msdyn_workorder_connections1: WebMappingRetrieve<web.Connection_Select,web.Connection_Expand,web.Connection_Filter,web.Connection_Fixed,web.Connection_Result,web.Connection_FormattedResult>;
    msdyn_workorder_connections2: WebMappingRetrieve<web.Connection_Select,web.Connection_Expand,web.Connection_Filter,web.Connection_Fixed,web.Connection_Result,web.Connection_FormattedResult>;
  }
}
interface WebEntitiesRetrieve {
  msdyn_workorders: WebMappingRetrieve<web.msdyn_workorder_Select,web.msdyn_workorder_Expand,web.msdyn_workorder_Filter,web.msdyn_workorder_Fixed,web.msdyn_workorder_Result,web.msdyn_workorder_FormattedResult>;
}
interface WebEntitiesRelated {
  msdyn_workorders: WebMappingRelated<web.msdyn_workorder_RelatedOne,web.msdyn_workorder_RelatedMany>;
}
interface WebEntitiesCUDA {
  msdyn_workorders: WebMappingCUDA<web.msdyn_workorder_Create,web.msdyn_workorder_Update,web.msdyn_workorder_Select>;
}
