declare namespace web {
  ...
  interface BulkOperationLog_RelatedOne {
    createdobjectid_account: WebMappingRetrieve<web.Account_Select,web.Account_Expand,web.Account_Filter,web.Account_Fixed,web.Account_Result,web.Account_FormattedResult>;
    createdobjectid_contact: WebMappingRetrieve<web.Contact_Select,web.Contact_Expand,web.Contact_Filter,web.Contact_Fixed,web.Contact_Result,web.Contact_FormattedResult>;
  ...
  interface BulkOperationLog_RelatedMany {
    BulkOperation_Logs_Accounts: WebMappingRetrieve<web.Account_Select,web.Account_Expand,web.Account_Filter,web.Account_Fixed,web.Account_Result,web.Account_FormattedResult>;
    BulkOperation_Logs_Contacts: WebMappingRetrieve<web.Contact_Select,web.Contact_Expand,web.Contact_Filter,web.Contact_Fixed,web.Contact_Result,web.Contact_FormattedResult>;
    CampaignActivity_Logs_Accounts: WebMappingRetrieve<web.Account_Select,web.Account_Expand,web.Account_Filter,web.Account_Fixed,web.Account_Result,web.Account_FormattedResult>;
    CampaignActivity_Logs_Contacts: WebMappingRetrieve<web.Contact_Select,web.Contact_Expand,web.Contact_Filter,web.Contact_Fixed,web.Contact_Result,web.Contact_FormattedResult>;
  }
}
interface WebEntitiesRetrieve {
  bulkoperationlogs: WebMappingRetrieve<web.BulkOperationLog_Select,web.BulkOperationLog_Expand,web.BulkOperationLog_Filter,web.BulkOperationLog_Fixed,web.BulkOperationLog_Result,web.BulkOperationLog_FormattedResult>;
}
interface WebEntitiesRelated {
  bulkoperationlogs: WebMappingRelated<web.BulkOperationLog_RelatedOne,web.BulkOperationLog_RelatedMany>;
}
interface WebEntitiesCUDA {
  bulkoperationlogs: WebMappingCUDA<web.BulkOperationLog_Create,web.BulkOperationLog_Update,web.BulkOperationLog_Select>;
}
