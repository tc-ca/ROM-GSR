...
interface tc_ACFacilityContacts_Expand {
  ownerid: WebExpand<tc_ACFacilityContacts_Expand, Team_Select, Team_Filter, { ownerid: Team_Result }>;
  owningteam: WebExpand<tc_ACFacilityContacts_Expand, Team_Select, Team_Filter, { owningteam: Team_Result }>;
