declare namespace web {
  ...
  interface tc_ACFacilityContacts_RelatedOne {
    ...
    tc_ContactId: WebMappingRetrieve<web.Contact_Select,web.Contact_Expand,web.Contact_Filter,web.Contact_Fixed,web.Contact_Result,web.Contact_FormattedResult>;
  }
  interface tc_ACFacilityContacts_RelatedMany {
  }
}
interface WebEntitiesRetrieve {
  tc_acfacilitycontactses: WebMappingRetrieve<web.tc_ACFacilityContacts_Select,web.tc_ACFacilityContacts_Expand,web.tc_ACFacilityContacts_Filter,web.tc_ACFacilityContacts_Fixed,web.tc_ACFacilityContacts_Result,web.tc_ACFacilityContacts_FormattedResult>;
}
interface WebEntitiesRelated {
  tc_acfacilitycontactses: WebMappingRelated<web.tc_ACFacilityContacts_RelatedOne,web.tc_ACFacilityContacts_RelatedMany>;
}
interface WebEntitiesCUDA {
  tc_acfacilitycontactses: WebMappingCUDA<web.tc_ACFacilityContacts_Create,web.tc_ACFacilityContacts_Update,web.tc_ACFacilityContacts_Select>;
}
