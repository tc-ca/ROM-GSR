...
interface Appointment extends Appointment_Base, Appointment_Relationships {
  ...
  regardingobjectid_adx_ad_appointment_bind$adx_ads?: string | null;
  regardingobjectid_adx_adplacement_appointment_bind$adx_adplacements?: string | null;
  regardingobjectid_adx_invitation_appointment_bind$adx_invitations?: string | null;
  regardingobjectid_adx_poll_appointment_bind$adx_polls?: string | null;
  regardingobjectid_adx_polloption_appointment_bind$adx_polloptions?: string | null;
  regardingobjectid_adx_pollplacement_appointment_bind$adx_pollplacements?: string | null;
  regardingobjectid_adx_pollsubmission_appointment_bind$adx_pollsubmissions?: string | null;
  regardingobjectid_adx_publishingstatetransitionrule_appointment_bind$adx_publishingstatetransitionrules?: string | null;
  regardingobjectid_adx_redirect_appointment_bind$adx_redirects?: string | null;
  regardingobjectid_adx_shortcut_appointment_bind$adx_shortcuts?: string | null;
  regardingobjectid_adx_webpage_appointment_bind$adx_webpages?: string | null;
  regardingobjectid_adx_website_appointment_bind$adx_websites?: string | null;
...
interface Appointment_Expand {
  ...
  ownerid_appointment: WebExpand<Appointment_Expand, Team_Select, Team_Filter, { ownerid_appointment: Team_Result }>;
