...
interface tc_TCLocationType_Expand {
  ownerid: WebExpand<tc_TCLocationType_Expand, Team_Select, Team_Filter, { ownerid: Team_Result }>;
  owningteam: WebExpand<tc_TCLocationType_Expand, Team_Select, Team_Filter, { owningteam: Team_Result }>;
}
