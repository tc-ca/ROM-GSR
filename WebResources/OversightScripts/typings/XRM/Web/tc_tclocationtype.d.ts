...
interface WebEntitiesRetrieve {
  tc_tclocationtypes: WebMappingRetrieve<web.tc_TCLocationType_Select,web.tc_TCLocationType_Expand,web.tc_TCLocationType_Filter,web.tc_TCLocationType_Fixed,web.tc_TCLocationType_Result,web.tc_TCLocationType_FormattedResult>;
}
interface WebEntitiesRelated {
  tc_tclocationtypes: WebMappingRelated<web.tc_TCLocationType_RelatedOne,web.tc_TCLocationType_RelatedMany>;
}
interface WebEntitiesCUDA {
  tc_tclocationtypes: WebMappingCUDA<web.tc_TCLocationType_Create,web.tc_TCLocationType_Update,web.tc_TCLocationType_Select>;
}
