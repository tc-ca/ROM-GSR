...
interface WebEntitiesRetrieve {
  postfollows: WebMappingRetrieve<web.PostFollow_Select,web.PostFollow_Expand,web.PostFollow_Filter,web.PostFollow_Fixed,web.PostFollow_Result,web.PostFollow_FormattedResult>;
}
interface WebEntitiesRelated {
  postfollows: WebMappingRelated<web.PostFollow_RelatedOne,web.PostFollow_RelatedMany>;
}
interface WebEntitiesCUDA {
  postfollows: WebMappingCUDA<web.PostFollow_Create,web.PostFollow_Update,web.PostFollow_Select>;
}
