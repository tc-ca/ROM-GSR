...
interface tc_Province_Relationships {
  tc_Country?: tc_Country_Result | null;
}
...
interface tc_Province_Expand {
  ownerid: WebExpand<tc_Province_Expand, Team_Select, Team_Filter, { ownerid: Team_Result }>;
  owningteam: WebExpand<tc_Province_Expand, Team_Select, Team_Filter, { owningteam: Team_Result }>;
  tc_Country: WebExpand<tc_Province_Expand, tc_Country_Select, tc_Country_Filter, { tc_Country: tc_Country_Result }>;
}
...
interface tc_Province_RelatedOne {
  ...
  tc_Country: WebMappingRetrieve<tc_Country_Select,tc_Country_Expand,tc_Country_Filter,tc_Country_Fixed,tc_Country_Result,tc_Country_FormattedResult>;
}
interface tc_Province_RelatedMany {
}
interface WebEntitiesRetrieve {
  tc_provinces: WebMappingRetrieve<tc_Province_Select,tc_Province_Expand,tc_Province_Filter,tc_Province_Fixed,tc_Province_Result,tc_Province_FormattedResult>;
}
interface WebEntitiesRelated {
  tc_provinces: WebMappingRelated<tc_Province_RelatedOne,tc_Province_RelatedMany>;
}
interface WebEntitiesCUDA {
  tc_provinces: WebMappingCUDA<tc_Province_Create,tc_Province_Update,tc_Province_Select>;
}
