declare namespace web {
  ...
  interface tc_TCFiscalYear_RelatedMany {
    ovs_msdyn_workorder_FiscalYear_tc_TCFiscalYea: WebMappingRetrieve<web.msdyn_workorder_Select,web.msdyn_workorder_Expand,web.msdyn_workorder_Filter,web.msdyn_workorder_Fixed,web.msdyn_workorder_Result,web.msdyn_workorder_FormattedResult>;
    tc_TCFiscalPeriod_TCFiscalYear: WebMappingRetrieve<web.tc_TCFiscalPeriod_Select,web.tc_TCFiscalPeriod_Expand,web.tc_TCFiscalPeriod_Filter,web.tc_TCFiscalPeriod_Fixed,web.tc_TCFiscalPeriod_Result,web.tc_TCFiscalPeriod_FormattedResult>;
    tc_TCFiscalQuarter_TCFiscalYear: WebMappingRetrieve<web.tc_TCFiscalQuarter_Select,web.tc_TCFiscalQuarter_Expand,web.tc_TCFiscalQuarter_Filter,web.tc_TCFiscalQuarter_Fixed,web.tc_TCFiscalQuarter_Result,web.tc_TCFiscalQuarter_FormattedResult>;
  }
}
interface WebEntitiesRetrieve {
  tc_tcfiscalyears: WebMappingRetrieve<web.tc_TCFiscalYear_Select,web.tc_TCFiscalYear_Expand,web.tc_TCFiscalYear_Filter,web.tc_TCFiscalYear_Fixed,web.tc_TCFiscalYear_Result,web.tc_TCFiscalYear_FormattedResult>;
}
interface WebEntitiesRelated {
  tc_tcfiscalyears: WebMappingRelated<web.tc_TCFiscalYear_RelatedOne,web.tc_TCFiscalYear_RelatedMany>;
}
interface WebEntitiesCUDA {
  tc_tcfiscalyears: WebMappingCUDA<web.tc_TCFiscalYear_Create,web.tc_TCFiscalYear_Update,web.tc_TCFiscalYear_Select>;
}
