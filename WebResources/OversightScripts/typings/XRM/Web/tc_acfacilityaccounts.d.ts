...
interface WebEntitiesRetrieve {
  tc_acfacilityaccountses: WebMappingRetrieve<web.tc_ACFacilityAccounts_Select,web.tc_ACFacilityAccounts_Expand,web.tc_ACFacilityAccounts_Filter,web.tc_ACFacilityAccounts_Fixed,web.tc_ACFacilityAccounts_Result,web.tc_ACFacilityAccounts_FormattedResult>;
}
interface WebEntitiesRelated {
  tc_acfacilityaccountses: WebMappingRelated<web.tc_ACFacilityAccounts_RelatedOne,web.tc_ACFacilityAccounts_RelatedMany>;
}
interface WebEntitiesCUDA {
  tc_acfacilityaccountses: WebMappingCUDA<web.tc_ACFacilityAccounts_Create,web.tc_ACFacilityAccounts_Update,web.tc_ACFacilityAccounts_Select>;
}
