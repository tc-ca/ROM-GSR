...
interface tc_ACFacilityAccounts_Expand {
  ownerid: WebExpand<tc_ACFacilityAccounts_Expand, Team_Select, Team_Filter, { ownerid: Team_Result }>;
  owningteam: WebExpand<tc_ACFacilityAccounts_Expand, Team_Select, Team_Filter, { owningteam: Team_Result }>;
