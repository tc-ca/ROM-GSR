declare namespace web {
  ...
  interface tc_TCAccountFacilityRelationType_RelatedMany {
    tc_ACFacilityAccounts_TCAccountFacilityRe: WebMappingRetrieve<web.tc_ACFacilityAccounts_Select,web.tc_ACFacilityAccounts_Expand,web.tc_ACFacilityAccounts_Filter,web.tc_ACFacilityAccounts_Fixed,web.tc_ACFacilityAccounts_Result,web.tc_ACFacilityAccounts_FormattedResult>;
    tc_ACFacilityLocationAccount_TCAccountFac: WebMappingRetrieve<web.tc_ACFacilityLocationAccount_Select,web.tc_ACFacilityLocationAccount_Expand,web.tc_ACFacilityLocationAccount_Filter,web.tc_ACFacilityLocationAccount_Fixed,web.tc_ACFacilityLocationAccount_Result,web.tc_ACFacilityLocationAccount_FormattedResult>;
  }
}
interface WebEntitiesRetrieve {
  tc_tcaccountfacilityrelationtypes: WebMappingRetrieve<web.tc_TCAccountFacilityRelationType_Select,web.tc_TCAccountFacilityRelationType_Expand,web.tc_TCAccountFacilityRelationType_Filter,web.tc_TCAccountFacilityRelationType_Fixed,web.tc_TCAccountFacilityRelationType_Result,web.tc_TCAccountFacilityRelationType_FormattedResult>;
}
interface WebEntitiesRelated {
  tc_tcaccountfacilityrelationtypes: WebMappingRelated<web.tc_TCAccountFacilityRelationType_RelatedOne,web.tc_TCAccountFacilityRelationType_RelatedMany>;
}
interface WebEntitiesCUDA {
  tc_tcaccountfacilityrelationtypes: WebMappingCUDA<web.tc_TCAccountFacilityRelationType_Create,web.tc_TCAccountFacilityRelationType_Update,web.tc_TCAccountFacilityRelationType_Select>;
}
