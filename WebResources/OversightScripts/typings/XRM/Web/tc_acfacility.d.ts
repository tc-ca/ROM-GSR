...
interface tc_ACFacility_Expand {
  ownerid: WebExpand<tc_ACFacility_Expand, Team_Select, Team_Filter, { ownerid: Team_Result }>;
  owningteam: WebExpand<tc_ACFacility_Expand, Team_Select, Team_Filter, { owningteam: Team_Result }>;
...
interface tc_ACFacility_RelatedOne {
  ...
  tc_TCFacilityTypeId: WebMappingRetrieve<tc_TCFacilityType_Select,tc_TCFacilityType_Expand,tc_TCFacilityType_Filter,tc_TCFacilityType_Fixed,tc_TCFacilityType_Result,tc_TCFacilityType_FormattedResult>;
}
interface tc_ACFacility_RelatedMany {
  tc_ACFacilityAccounts_ACFacility: WebMappingRetrieve<tc_ACFacilityAccounts_Select,tc_ACFacilityAccounts_Expand,tc_ACFacilityAccounts_Filter,tc_ACFacilityAccounts_Fixed,tc_ACFacilityAccounts_Result,tc_ACFacilityAccounts_FormattedResult>;
  tc_ACFacilityContacts_ACFacility: WebMappingRetrieve<tc_ACFacilityContacts_Select,tc_ACFacilityContacts_Expand,tc_ACFacilityContacts_Filter,tc_ACFacilityContacts_Fixed,tc_ACFacilityContacts_Result,tc_ACFacilityContacts_FormattedResult>;
  tc_ACFacilityLocation_ACFacility: WebMappingRetrieve<tc_ACFacilityLocation_Select,tc_ACFacilityLocation_Expand,tc_ACFacilityLocation_Filter,tc_ACFacilityLocation_Fixed,tc_ACFacilityLocation_Result,tc_ACFacilityLocation_FormattedResult>;
}
interface WebEntitiesRetrieve {
  tc_acfacilities: WebMappingRetrieve<tc_ACFacility_Select,tc_ACFacility_Expand,tc_ACFacility_Filter,tc_ACFacility_Fixed,tc_ACFacility_Result,tc_ACFacility_FormattedResult>;
}
interface WebEntitiesRelated {
  tc_acfacilities: WebMappingRelated<tc_ACFacility_RelatedOne,tc_ACFacility_RelatedMany>;
}
interface WebEntitiesCUDA {
  tc_acfacilities: WebMappingCUDA<tc_ACFacility_Create,tc_ACFacility_Update,tc_ACFacility_Select>;
}
