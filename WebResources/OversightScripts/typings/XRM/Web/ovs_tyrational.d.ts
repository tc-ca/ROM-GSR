declare namespace web {
  ...
  interface ovs_TYRational_RelatedMany {
    msdyn_workorder_TYRational_ovs_TYRational: WebMappingRetrieve<web.msdyn_workorder_Select,web.msdyn_workorder_Expand,web.msdyn_workorder_Filter,web.msdyn_workorder_Fixed,web.msdyn_workorder_Result,web.msdyn_workorder_FormattedResult>;
  }
}
interface WebEntitiesRetrieve {
  ovs_tyrationals: WebMappingRetrieve<web.ovs_TYRational_Select,web.ovs_TYRational_Expand,web.ovs_TYRational_Filter,web.ovs_TYRational_Fixed,web.ovs_TYRational_Result,web.ovs_TYRational_FormattedResult>;
}
interface WebEntitiesRelated {
  ovs_tyrationals: WebMappingRelated<web.ovs_TYRational_RelatedOne,web.ovs_TYRational_RelatedMany>;
}
interface WebEntitiesCUDA {
  ovs_tyrationals: WebMappingCUDA<web.ovs_TYRational_Create,web.ovs_TYRational_Update,web.ovs_TYRational_Select>;
}
