...
interface tc_TCFacilityType_Expand {
  ownerid: WebExpand<tc_TCFacilityType_Expand, Team_Select, Team_Filter, { ownerid: Team_Result }>;
  owningteam: WebExpand<tc_TCFacilityType_Expand, Team_Select, Team_Filter, { owningteam: Team_Result }>;
