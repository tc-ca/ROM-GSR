declare namespace web {
  ...
  interface tc_TCFacilityType_RelatedMany {
    tc_ACFacility_TCFacilityType: WebMappingRetrieve<web.tc_ACFacility_Select,web.tc_ACFacility_Expand,web.tc_ACFacility_Filter,web.tc_ACFacility_Fixed,web.tc_ACFacility_Result,web.tc_ACFacility_FormattedResult>;
  }
}
interface WebEntitiesRetrieve {
  tc_tcfacilitytypes: WebMappingRetrieve<web.tc_TCFacilityType_Select,web.tc_TCFacilityType_Expand,web.tc_TCFacilityType_Filter,web.tc_TCFacilityType_Fixed,web.tc_TCFacilityType_Result,web.tc_TCFacilityType_FormattedResult>;
}
interface WebEntitiesRelated {
  tc_tcfacilitytypes: WebMappingRelated<web.tc_TCFacilityType_RelatedOne,web.tc_TCFacilityType_RelatedMany>;
}
interface WebEntitiesCUDA {
  tc_tcfacilitytypes: WebMappingCUDA<web.tc_TCFacilityType_Create,web.tc_TCFacilityType_Update,web.tc_TCFacilityType_Select>;
}
