declare namespace web {
  ...
  interface tc_ACFacilityLocationAccount_RelatedOne {
    tc_ACFacilityLocationId: WebMappingRetrieve<web.tc_ACFacilityLocation_Select,web.tc_ACFacilityLocation_Expand,web.tc_ACFacilityLocation_Filter,web.tc_ACFacilityLocation_Fixed,web.tc_ACFacilityLocation_Result,web.tc_ACFacilityLocation_FormattedResult>;
    tc_TCAccountFacilityRelationTypeId: WebMappingRetrieve<web.tc_TCAccountFacilityRelationType_Select,web.tc_TCAccountFacilityRelationType_Expand,web.tc_TCAccountFacilityRelationType_Filter,web.tc_TCAccountFacilityRelationType_Fixed,web.tc_TCAccountFacilityRelationType_Result,web.tc_TCAccountFacilityRelationType_FormattedResult>;
    tc_accountid: WebMappingRetrieve<web.Account_Select,web.Account_Expand,web.Account_Filter,web.Account_Fixed,web.Account_Result,web.Account_FormattedResult>;
  }
  interface tc_ACFacilityLocationAccount_RelatedMany {
  }
}
interface WebEntitiesRetrieve {
  tc_acfacilitylocationaccounts: WebMappingRetrieve<web.tc_ACFacilityLocationAccount_Select,web.tc_ACFacilityLocationAccount_Expand,web.tc_ACFacilityLocationAccount_Filter,web.tc_ACFacilityLocationAccount_Fixed,web.tc_ACFacilityLocationAccount_Result,web.tc_ACFacilityLocationAccount_FormattedResult>;
}
interface WebEntitiesRelated {
  tc_acfacilitylocationaccounts: WebMappingRelated<web.tc_ACFacilityLocationAccount_RelatedOne,web.tc_ACFacilityLocationAccount_RelatedMany>;
}
interface WebEntitiesCUDA {
  tc_acfacilitylocationaccounts: WebMappingCUDA<web.tc_ACFacilityLocationAccount_Create,web.tc_ACFacilityLocationAccount_Update,web.tc_ACFacilityLocationAccount_Select>;
}
