...
interface tc_ACFacilityLocationAccount_Expand {
  ownerid: WebExpand<tc_ACFacilityLocationAccount_Expand, Team_Select, Team_Filter, { ownerid: Team_Result }>;
  owningteam: WebExpand<tc_ACFacilityLocationAccount_Expand, Team_Select, Team_Filter, { owningteam: Team_Result }>;
