declare namespace web {
  ...
  interface Contact_Relationships {
    ...
    tc_ACFacilityContacts_Contact?: tc_ACFacilityContacts_Result[] | null;
  }
  ...
  interface Contact_Expand {
    ...
    tc_ACFacilityContacts_Contact: WebExpand<Contact_Expand, tc_ACFacilityContacts_Select, tc_ACFacilityContacts_Filter, { tc_ACFacilityContacts_Contact: tc_ACFacilityContacts_Result[] }>;
  }
  ...
  interface Contact_RelatedMany {
    CreatedContact_BulkOperationLogs: WebMappingRetrieve<web.BulkOperationLog_Select,web.BulkOperationLog_Expand,web.BulkOperationLog_Filter,web.BulkOperationLog_Fixed,web.BulkOperationLog_Result,web.BulkOperationLog_FormattedResult>;
    SourceContact_BulkOperationLogs: WebMappingRetrieve<web.BulkOperationLog_Select,web.BulkOperationLog_Expand,web.BulkOperationLog_Filter,web.BulkOperationLog_Fixed,web.BulkOperationLog_Result,web.BulkOperationLog_FormattedResult>;
    ...
    contact_PostFollows: WebMappingRetrieve<web.PostFollow_Select,web.PostFollow_Expand,web.PostFollow_Filter,web.PostFollow_Fixed,web.PostFollow_Result,web.PostFollow_FormattedResult>;
    ...
    contact_bookableresource_ContactId: WebMappingRetrieve<web.BookableResource_Select,web.BookableResource_Expand,web.BookableResource_Filter,web.BookableResource_Fixed,web.BookableResource_Result,web.BookableResource_FormattedResult>;
    ...
    msdyn_contact_msdyn_workorder_ReportedByContact: WebMappingRetrieve<web.msdyn_workorder_Select,web.msdyn_workorder_Expand,web.msdyn_workorder_Filter,web.msdyn_workorder_Fixed,web.msdyn_workorder_Result,web.msdyn_workorder_FormattedResult>;
    tc_ACFacilityContacts_Contact: WebMappingRetrieve<web.tc_ACFacilityContacts_Select,web.tc_ACFacilityContacts_Expand,web.tc_ACFacilityContacts_Filter,web.tc_ACFacilityContacts_Fixed,web.tc_ACFacilityContacts_Result,web.tc_ACFacilityContacts_FormattedResult>;
  }
}
