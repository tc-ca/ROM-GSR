...
interface Contact_Expand {
  ...
  ownerid: WebExpand<Contact_Expand, Team_Select, Team_Filter, { ownerid: Team_Result }>;
...
interface Contact_RelatedMany {
  ...
  tc_ACFacilityContacts_Contact: WebMappingRetrieve<tc_ACFacilityContacts_Select,tc_ACFacilityContacts_Expand,tc_ACFacilityContacts_Filter,tc_ACFacilityContacts_Fixed,tc_ACFacilityContacts_Result,tc_ACFacilityContacts_FormattedResult>;
}
