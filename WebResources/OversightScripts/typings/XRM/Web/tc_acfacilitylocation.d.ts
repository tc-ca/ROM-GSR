...
interface tc_ACFacilityLocation_Expand {
  ownerid: WebExpand<tc_ACFacilityLocation_Expand, Team_Select, Team_Filter, { ownerid: Team_Result }>;
  owningteam: WebExpand<tc_ACFacilityLocation_Expand, Team_Select, Team_Filter, { owningteam: Team_Result }>;
...
interface tc_ACFacilityLocation_RelatedMany {
  tc_ACFacilityLocationAccount_ACFacilityLo: WebMappingRetrieve<tc_ACFacilityLocationAccount_Select,tc_ACFacilityLocationAccount_Expand,tc_ACFacilityLocationAccount_Filter,tc_ACFacilityLocationAccount_Fixed,tc_ACFacilityLocationAccount_Result,tc_ACFacilityLocationAccount_FormattedResult>;
}
interface WebEntitiesRetrieve {
  tc_acfacilitylocations: WebMappingRetrieve<tc_ACFacilityLocation_Select,tc_ACFacilityLocation_Expand,tc_ACFacilityLocation_Filter,tc_ACFacilityLocation_Fixed,tc_ACFacilityLocation_Result,tc_ACFacilityLocation_FormattedResult>;
}
interface WebEntitiesRelated {
  tc_acfacilitylocations: WebMappingRelated<tc_ACFacilityLocation_RelatedOne,tc_ACFacilityLocation_RelatedMany>;
}
interface WebEntitiesCUDA {
  tc_acfacilitylocations: WebMappingCUDA<tc_ACFacilityLocation_Create,tc_ACFacilityLocation_Update,tc_ACFacilityLocation_Select>;
}
