declare namespace web {
  ...
  interface tc_TCFiscalPeriod_RelatedOne {
    tc_TCFiscalQuarterId: WebMappingRetrieve<web.tc_TCFiscalQuarter_Select,web.tc_TCFiscalQuarter_Expand,web.tc_TCFiscalQuarter_Filter,web.tc_TCFiscalQuarter_Fixed,web.tc_TCFiscalQuarter_Result,web.tc_TCFiscalQuarter_FormattedResult>;
    ...
    tc_TCMonthId: WebMappingRetrieve<web.tc_TCMonth_Select,web.tc_TCMonth_Expand,web.tc_TCMonth_Filter,web.tc_TCMonth_Fixed,web.tc_TCMonth_Result,web.tc_TCMonth_FormattedResult>;
  }
  interface tc_TCFiscalPeriod_RelatedMany {
  }
}
interface WebEntitiesRetrieve {
  tc_tcfiscalperiods: WebMappingRetrieve<web.tc_TCFiscalPeriod_Select,web.tc_TCFiscalPeriod_Expand,web.tc_TCFiscalPeriod_Filter,web.tc_TCFiscalPeriod_Fixed,web.tc_TCFiscalPeriod_Result,web.tc_TCFiscalPeriod_FormattedResult>;
}
interface WebEntitiesRelated {
  tc_tcfiscalperiods: WebMappingRelated<web.tc_TCFiscalPeriod_RelatedOne,web.tc_TCFiscalPeriod_RelatedMany>;
}
interface WebEntitiesCUDA {
  tc_tcfiscalperiods: WebMappingCUDA<web.tc_TCFiscalPeriod_Create,web.tc_TCFiscalPeriod_Update,web.tc_TCFiscalPeriod_Select>;
}
