declare namespace web {
  ...
  interface Account_Relationships {
    ...
    tc_ACFacilityAccounts_AccountId?: tc_ACFacilityAccounts_Result[] | null;
    tc_ACFacilityLocationAccount_accountid_Ac?: tc_ACFacilityLocationAccount_Result[] | null;
  }
  ...
  interface Account_Expand {
    ...
    tc_ACFacilityAccounts_AccountId: WebExpand<Account_Expand, tc_ACFacilityAccounts_Select, tc_ACFacilityAccounts_Filter, { tc_ACFacilityAccounts_AccountId: tc_ACFacilityAccounts_Result[] }>;
    tc_ACFacilityLocationAccount_accountid_Ac: WebExpand<Account_Expand, tc_ACFacilityLocationAccount_Select, tc_ACFacilityLocationAccount_Filter, { tc_ACFacilityLocationAccount_accountid_Ac: tc_ACFacilityLocationAccount_Result[] }>;
  }
  ...
  interface Account_RelatedOne {
    ...
    msdyn_billingaccount_account: WebMappingRetrieve<web.Account_Select,web.Account_Expand,web.Account_Filter,web.Account_Fixed,web.Account_Result,web.Account_FormattedResult>;
  ...
  interface Account_RelatedMany {
    CreatedAccount_BulkOperationLogs2: WebMappingRetrieve<web.BulkOperationLog_Select,web.BulkOperationLog_Expand,web.BulkOperationLog_Filter,web.BulkOperationLog_Fixed,web.BulkOperationLog_Result,web.BulkOperationLog_FormattedResult>;
    SourceAccount_BulkOperationLogs: WebMappingRetrieve<web.BulkOperationLog_Select,web.BulkOperationLog_Expand,web.BulkOperationLog_Filter,web.BulkOperationLog_Fixed,web.BulkOperationLog_Result,web.BulkOperationLog_FormattedResult>;
    account_PostFollows: WebMappingRetrieve<web.PostFollow_Select,web.PostFollow_Expand,web.PostFollow_Filter,web.PostFollow_Fixed,web.PostFollow_Result,web.PostFollow_FormattedResult>;
    ...
    account_bookableresource_AccountId: WebMappingRetrieve<web.BookableResource_Select,web.BookableResource_Expand,web.BookableResource_Filter,web.BookableResource_Fixed,web.BookableResource_Result,web.BookableResource_FormattedResult>;
    ...
    msdyn_account_account_BillingAccount: WebMappingRetrieve<web.Account_Select,web.Account_Expand,web.Account_Filter,web.Account_Fixed,web.Account_Result,web.Account_FormattedResult>;
    msdyn_account_msdyn_workorder_BillingAccount: WebMappingRetrieve<web.msdyn_workorder_Select,web.msdyn_workorder_Expand,web.msdyn_workorder_Filter,web.msdyn_workorder_Fixed,web.msdyn_workorder_Result,web.msdyn_workorder_FormattedResult>;
    msdyn_account_msdyn_workorder_ServiceAccount: WebMappingRetrieve<web.msdyn_workorder_Select,web.msdyn_workorder_Expand,web.msdyn_workorder_Filter,web.msdyn_workorder_Fixed,web.msdyn_workorder_Result,web.msdyn_workorder_FormattedResult>;
    tc_ACFacilityAccounts_AccountId: WebMappingRetrieve<web.tc_ACFacilityAccounts_Select,web.tc_ACFacilityAccounts_Expand,web.tc_ACFacilityAccounts_Filter,web.tc_ACFacilityAccounts_Fixed,web.tc_ACFacilityAccounts_Result,web.tc_ACFacilityAccounts_FormattedResult>;
    tc_ACFacilityLocationAccount_accountid_Ac: WebMappingRetrieve<web.tc_ACFacilityLocationAccount_Select,web.tc_ACFacilityLocationAccount_Expand,web.tc_ACFacilityLocationAccount_Filter,web.tc_ACFacilityLocationAccount_Fixed,web.tc_ACFacilityLocationAccount_Result,web.tc_ACFacilityLocationAccount_FormattedResult>;
  }
}
