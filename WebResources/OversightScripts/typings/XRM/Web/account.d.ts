...
interface Account_Expand {
  ...
  ownerid: WebExpand<Account_Expand, Team_Select, Team_Filter, { ownerid: Team_Result }>;
  ...
  tc_Account_Account_Account_test_ains: WebExpand<Account_Expand, Account_Select, Account_Filter, { tc_Account_Account_Account_test_ains: Account_Result[] }>;
...
interface Account_RelatedMany {
  ...
  tc_ACFacilityAccounts_AccountId: WebMappingRetrieve<tc_ACFacilityAccounts_Select,tc_ACFacilityAccounts_Expand,tc_ACFacilityAccounts_Filter,tc_ACFacilityAccounts_Fixed,tc_ACFacilityAccounts_Result,tc_ACFacilityAccounts_FormattedResult>;
  tc_ACFacilityLocationAccount_accountid_Ac: WebMappingRetrieve<tc_ACFacilityLocationAccount_Select,tc_ACFacilityLocationAccount_Expand,tc_ACFacilityLocationAccount_Filter,tc_ACFacilityLocationAccount_Fixed,tc_ACFacilityLocationAccount_Result,tc_ACFacilityLocationAccount_FormattedResult>;
