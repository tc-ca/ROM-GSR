declare namespace Form.ovs_operation.Main {
  namespace Information {
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "ovs_operationtype"): Xrm.OptionSetAttribute<ovs_operation_ovs_operationtype>;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "ovs_operationtype"): Xrm.OptionSetControl<ovs_operation_ovs_operationtype>;
  ...
  interface Information extends Xrm.PageBase<Information.Attributes,Information.Tabs,Information.Controls> {
    ...
    getAttribute(attributeName: "ovs_operationtype"): Xrm.OptionSetAttribute<ovs_operation_ovs_operationtype>;
    ...
    getControl(controlName: "ovs_operationtype"): Xrm.OptionSetControl<ovs_operation_ovs_operationtype>;
