declare namespace Form.contact.Main {
  ...
  interface Contacttestdonotuse extends Xrm.PageBase<Contacttestdonotuse.Attributes,Contacttestdonotuse.Tabs,Contacttestdonotuse.Controls> {
