declare namespace Form.msdyn_workorder.Main {
  namespace WorkOrderService {
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "FsWorkOrderProductsGrid"): Xrm.SubGridControl<"msdyn_workorderproduct">;
      get(name: "FsWorkOrderServiceTasksGrid"): Xrm.SubGridControl<"msdyn_workorderservicetask">;
      get(name: "FsWorkOrderServicesGrid"): Xrm.SubGridControl<"msdyn_workorderservice">;
  ...
  interface WorkOrderService extends Xrm.PageBase<WorkOrderService.Attributes,WorkOrderService.Tabs,WorkOrderService.Controls> {
    ...
    getControl(controlName: "FsWorkOrderProductsGrid"): Xrm.SubGridControl<"msdyn_workorderproduct">;
    getControl(controlName: "FsWorkOrderServiceTasksGrid"): Xrm.SubGridControl<"msdyn_workorderservicetask">;
    getControl(controlName: "FsWorkOrderServicesGrid"): Xrm.SubGridControl<"msdyn_workorderservice">;
